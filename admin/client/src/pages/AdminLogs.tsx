...
import { adminLogs } from '../app/data/adminMockData';
import {
  Select,
  SelectContent,
  SelectItem,
        ...
        <Card className="p-4 border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold">{adminLogs.length}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4 border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-purple-600">47</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6 shadow-md border-border">
            ...
            <tbody>
              {adminLogs.map((log) => (
                ...
                >
                  ...
                  <td className="py-4 px-4">
                    <Badge className={`${targetTypeColors[log.targetType as keyof typeof targetTypeColors]} border`}>
                      {log.targetType}
                    </Badge>
                  </td>
                  <td className="py-4 px-4">
        ...
        <div className="flex items-center justify-between mt-6 pt-6 border-t border-border">
          <div className="text-sm text-muted-foreground">
            Showing 1 to {adminLogs.length} of {adminLogs.length} logs
          </div>
